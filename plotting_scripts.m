...
% Heat flow hot map and specified range
% figure('WindowState', 'maximize');
% randX = 10 + 20*rand([thermDims(1) + 1, thermDims(2:end)]);
% randY = 10 + 20*rand([thermDims(1), thermDims(2) + 1, thermDims(3)]);
% plot_lines(randX, randY, thermX, thermY, 'x', 'y', 1e-3, 3, [10 30], nan, 'heat flow', 'W')
...
% Plot full pack
figure('WindowState', 'maximize');
plot_grid(thermX, thermY, thermZ, 'Pack', 'xy'); % view can be, 3d, xy, xz, yz
axis equal;
